...
heroImage: "/blog/health-brand-retention-ltv-email-sms.webp"
heroAlt: "Ascending cohort retention curves on a dashboard rendered in AdBoost blue"
---
...
3. **Cancel-intercept flows.** Reason-specific saves: "too much product piling up" gets a frequency change, "too expensive" gets a smaller size, "not sure it's working" gets the expectation-setting content they missed. One generic 20%-off save offer trains customers to cancel for discounts.
4. **Win-back (30/60/90 days post-churn).** Sequenced by churn reason, not blasted. Recently lapsed customers respond to "pick up where you left off"; long-lapsed ones need a new angle entirely — new formulation, new format, new problem. Win-backs are the cheapest "acquisition" channel you have: the trust is already built.
5. **Replenishment reminders for non-subscribers.** Timed to actual consumption. This is the single most reliable path from one-time buyer to subscriber, because it catches the customer at the exact moment the product proved itself.
