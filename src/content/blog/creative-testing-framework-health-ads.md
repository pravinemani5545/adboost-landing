...
tags: ["creative testing", "ad creative", "Meta ads", "media buying", "measurement"]
heroImage: "/blog/creative-testing-framework-health-ads.webp"
heroAlt: "Test matrix of ad variants with scale and kill markers in AdBoost blue"
---
...
Test angles before hooks, and hooks before formats. An angle is a reason to buy; in a category where compliant angles are a constrained list (we mapped them in the [creative rejection playbook](/blog/health-ad-creative-rejected-fix/)), knowing which three angles carry your account is worth more than any single ad.
...
1. **Kill at ~25–30% of test budget** if hook rate and CTR are both well below account median. The creative can't earn attention; conversions won't save it.
2. **Kill at 100% of test budget** with zero conversions. No debate, no extension, no "but the comments are good."
3. **Extend one budget cycle** only for a specific, pre-named reason — e.g., CPA near target on low volume, or strong add-to-carts with a checkout-side explanation. "I like this ad" is not a reason.
4. **A winner must beat the control on CPA**, not merely achieve profitability. The bar is the champion.
