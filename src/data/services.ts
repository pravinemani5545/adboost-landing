...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    navLabel: 'Compliance review',
    h1: 'Compliance review before every launch',
    lede: 'The differentiator no generalist agency offers: every account and asset checked against Meta, Google, and TikTok health-vertical policy — plus FTC, FDA, and health-data law — before it goes live.',
    answer: 'AdBoost Health reviews every account and creative against Meta, Google, and TikTok health-vertical advertising policies, plus FTC substantiation, FDA structure/function rules, and health-data privacy law, before launch. That pre-clearance is why our partners’ accounts don’t get yanked mid-scale — and it’s the single biggest thing generalist agencies get wrong in health.',
    desc: 'Pre-launch ad-compliance review against Meta, Google, TikTok health policies, FTC/FDA standards, and health-data privacy law.',
    outcomes: [
      'Every account structured to platform health policy before launch',
      'Creative pre-cleared against the exact rejection triggers',
      'LegitScript / certification guidance for telehealth & pharmacy',
      'Pixel / CAPI data-flow audit to prevent health-data leakage',
    ],
    process: [
      { phase: 'Certification & policy audit · wk 1–2', detail: 'Confirm LegitScript certification status and scope, review platform eligibility (Meta/Google/Microsoft), and inventory every live claim against FTC and platform policy.' },
      { phase: 'Claims & substantiation review · wk 2–3', detail: 'Classify every claim as structure/function vs disease, map required substantiation (the FTC generally expects RCT-level evidence), and rewrite or pull anything unsupported.' },
      { phase: 'Data & tracking compliance · wk 2–4', detail: 'Audit pixel/CAPI data flows for health-data leakage, verify BAAs/consent where PHI is in scope, and remediate tracking that sends diagnostic or prescription signals to ad platforms.' },
      { phase: 'Governance & monitoring · ongoing', detail: 'Stand up a pre-publish review workflow, a claims register, and a recertification/monitoring calendar so compliance keeps pace with new creative and new state privacy laws.' },
    ],
    deliverables: [
      'LegitScript certification status review and remediation plan',
      'Claims audit classifying every asset as structure/function vs disease, with substantiation mapping',
      'Compliant copy/claims library and pre-publish review checklist',
      'Tracking/data-flow audit (pixel + CAPI) for health-data leakage, with BAA/consent guidance',
      'Platform-policy compliance report (Meta, Google, TikTok, YouTube)',
      'Recertification, monitoring, and state-privacy-law watch calendar',
    ],
    howMeasured: ['Ad account/asset approval vs disapproval rate', 'Claim-substantiation coverage (share of live claims with evidence on file)', 'Certification standing and zero unremediated data-leakage findings'],
    deepPoints: [
      { h: 'The pixel is now the biggest compliance liability, not the copy', p: 'A 2023–2025 analysis found 19 pixel-tracking cases totaling $100M+ in penalties. GoodRx drew a 20-year FTC order and $1.5M fine; BetterHelp, $7.8M in refunds — both for sending intake/prescription data to Meta and Google without a BAA. A standard pixel on a page that captures conditions or prescriptions is a live enforcement risk.' },
      { h: 'Structure/function vs disease is the line that keeps you on-platform', p: 'The FTC’s 2022 Health Products Compliance Guidance generally expects high-quality RCTs to substantiate health claims. "Supports healthy digestion" is defensible; "treats IBS" is a disease claim needing drug-level evidence. Misclassifying claims is what triggers both platform disapprovals and FTC notices.' },
      { h: 'Certification is table stakes, and the map keeps changing', p: 'LegitScript certification is required to advertise telehealth, online pharmacy, addiction treatment, and many supplement services on Meta, Google, and Microsoft — and eligibility rules keep shifting. Certification scope and geo-eligibility have to be re-checked, not assumed.' },
    ],
    stat: { text: 'Health-data pixel-tracking violations cost U.S. healthcare $100M+ across 19 enforcement cases (2023–2025), including BetterHelp’s $7.8M FTC settlement and GoodRx’s $1.5M fine.', source: 'Feroot / HIPAA Journal, 2025', url: 'https://www.feroot.com/blog/pixel-tracking-violations-us-healthcare-100m/' },
    sections: [
      { h: 'A rejected launch costs you a quarter', p: 'Disabled ad accounts and yanked campaigns are the most expensive mistakes in health marketing. We check account structure, targeting, claims, and creative against live policy so launches clear the first time.' },
      { h: 'Certification, done right', p: 'Google and Meta require LegitScript certification for telehealth and pharmacy advertisers, and the process has real gotchas. We guide certification and geo-eligibility so you’re not blocked at the starting line.' },
      { h: 'Claims that pass FTC and FDA', p: 'Structure/function vs disease claims, the mandatory FDA supplement disclaimer, FTC substantiation for "clinically proven" — we keep copy inside the lines that also draw enforcement.' },
    ],
    faq: [
      { q: 'Is compliance review a separate service?', a: 'It’s built into every engagement — no health account launches without it. We also advise standalone on certification, claims, and data-tracking strategy.' },
      { q: 'Do you guarantee ads won’t be rejected?', a: 'No one can guarantee a platform’s decision, but pre-clearance against the actual rejection triggers is why our partners’ accounts stay live through scale instead of getting flagged.' },
      { q: 'Can a standard Meta pixel get me in legal trouble?', a: 'Yes — if it sends condition or prescription data to an ad platform without a BAA and explicit authorization, it can violate health-data law. GoodRx and BetterHelp were fined for exactly this. We audit and remediate pixel/CAPI data flows.' },
    ],
  },
];
